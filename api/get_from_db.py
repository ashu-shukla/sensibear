...
# Function to get latest 5 days data.


def get_latest_five_days_data():
    # SQL to get latest 5 dates data from DB as a json object.
...
from (
    ...
    # Multiple records hence,[0][0]
    ret = data[0][0]
    return ret

# Function to get specific dates data.
